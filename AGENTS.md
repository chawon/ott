...
2. 현재 기준
   ...
   4. `2026-04-29` 기준 Google Play `alpha` 최신 버전은 `1.0.4` (`versionCode=8`)이며, Android 런처 shortcuts, PWA/TWA Web Share Target, 홈 위젯 영상/책/타임라인 액션 분리가 반영됐다. 모바일 실기기에서 위젯, 롱프레스 shortcuts, OTT 앱 공유 후 QuickLog 조회까지 확인 완료.
