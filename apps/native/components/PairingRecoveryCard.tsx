...
const styles = StyleSheet.create({
  ...
  topBar: { height: 5, backgroundColor: '#dbeafe' },
  bottomBar: { height: 5, backgroundColor: '#f59e0b' },
  body: {
    flex: 1,
    margin: 18,
    borderRadius: 14,
  ...
  eyebrow: { ...Typography.labelSm, color: '#1d4ed8' },
  title: { fontSize: 20, lineHeight: 25, fontWeight: '800', color: '#111827' },
  subtitle: { fontSize: 10, lineHeight: 15, fontWeight: '500', color: '#475569' },
  codeBox: {
    borderRadius: 12,
  ...
  codeLabel: { fontSize: 9, fontWeight: '800', color: '#93c5fd' },
  code: {
    width: '100%',
    textAlign: 'center',
    fontSize: 30,
  ...
  domain: { fontSize: 9, fontWeight: '500', color: '#cbd5e1' },
  section: { gap: 4 },
  sectionTitle: { fontSize: 12, lineHeight: 16, fontWeight: '800', color: '#111827' },
  paragraph: { fontSize: 10, lineHeight: 15, fontWeight: '500', color: '#475569' },
  warningBox: {
    borderRadius: 10,
    borderWidth: 1,
    borderColor: '#fed7aa',
  ...
  warningTitle: { fontSize: 11, lineHeight: 14, fontWeight: '800', color: '#9a3412' },
  warningText: { fontSize: 9, lineHeight: 13, fontWeight: '500', color: '#7c2d12' },
  divider: { height: 1, backgroundColor: '#e2e8f0', marginTop: 2 },
  footer: { fontSize: 8, lineHeight: 12, fontWeight: '500', color: '#64748b' },
});
