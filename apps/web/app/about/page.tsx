  ...
  return (
    <div className="max-w-2xl mx-auto space-y-10 py-10">
      ...
      <section className="space-y-6">
        <h2 className="text-xl font-semibold text-neutral-900 border-b pb-2">어떻게 사용하나요?</h2>
        <div className="grid gap-6">
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-medium text-neutral-900">작품 검색</h3>
              <p className="text-sm text-neutral-500">홈 화면 상단에서 영화나 시리즈 제목을 검색하세요.</p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-medium text-neutral-900">상태 및 평점 선택</h3>
              <p className="text-sm text-neutral-500">보고 있는 중인지, 다 봤는지 선택하고 가벼운 평점을 남겨주세요.</p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-medium text-neutral-900">기록 저장</h3>
              <p className="text-sm text-neutral-500">저장 즉시 나만의 타임라인이 구축됩니다. 모든 데이터는 브라우저에 안전하게 우선 저장됩니다.</p>
            </div>
          </div>
        </div>
      </section>

      <section className="bg-neutral-50 p-6 rounded-2xl border border-neutral-100 italic text-neutral-600">
