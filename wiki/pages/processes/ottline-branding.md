...
- `feature/ios-native-testflight`에서 React Native + Expo 기반 iOS TestFlight 후보를 기록 핵심 범위로 재정리 중
- iOS Bundle Identifier는 `app.ottline`, Android native package는 TWA와 분리해 `app.ottline.mobile`로 유지
