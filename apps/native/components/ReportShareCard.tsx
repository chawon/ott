...
const styles = StyleSheet.create({
  ...
  titleBlock: { gap: 10 },
  title: { color: '#0f0f0f', fontSize: 30, lineHeight: 37, fontWeight: '800' },
  subtitle: { color: '#4a4a4a', fontSize: 13, lineHeight: 20, fontWeight: '600' },
  stats: { gap: 10 },
  statCard: {
    borderRadius: 16,
    borderWidth: 1,
  ...
  statLabel: { color: '#4a4a4a', fontSize: 10, fontWeight: '800' },
  statValue: { color: '#0f0f0f', fontSize: 28, lineHeight: 34, fontWeight: '800' },
  revisitBox: {
    borderRadius: 16,
  ...
  revisitLabel: { color: '#ff9933', fontSize: 10, fontWeight: '800' },
  revisitText: { color: '#fff8ef', fontSize: 11, lineHeight: 17, fontWeight: '600' },
