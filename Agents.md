...
12) 플랫폼(OTT) 드롭다운 + 직접 입력 + 내 입력 목록 노출
    1. 타임라인 OTT 필터에서 그룹 선택 지원(그룹 선택 시 하위 OTT 포함)
...
24) 타임라인 연도 라벨 항상 노출 + 상태별 문구 적용
    1. ALL: 2026 (24)
    2. DONE/IN_PROGRESS/WISHLIST: “2026년에는 24편을 …”
25) 타임라인 날짜 표기 연-월-일로 통일, 작품 연도 표기 제거
26) 서비스 소개/FAQ에 PWA 설치·공유 카드·페어링 설명 보강
