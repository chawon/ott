  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8 py-10 text-foreground">
      ...
      <section className="space-y-3 text-sm leading-relaxed text-muted-foreground">
        <p>
          On the Timeline(이하 "서비스")는 이용자의 개인정보를 소중히 여기며,
          관련 법령을 준수합니다. 본 방침은 서비스 이용 중 처리되는 정보의 항목,
          목적, 보관 방식, 이용자 권리를 안내합니다.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
          ...
          <li>
            서비스 운영 정보: 기기 유형, 브라우저 유형, OS 계열, 설치 상태(PWA
            여부)
          </li>
          <li>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          서비스는 원칙적으로 이용자 정보를 외부에 판매하지 않으며, 법령에 따른
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          이용자는 자신의 기록 데이터에 대해 열람, 정정, 삭제를 요청할 수
          있습니다. 서비스 내 기능 또는 운영자 문의를 통해 요청할 수 있습니다.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          개인정보 관련 문의는 서비스 운영 채널을 통해 접수해 주세요. 접수된
          문의는 확인 후 지체 없이 처리합니다.
        </p>
      </section>
    </div>
  );
