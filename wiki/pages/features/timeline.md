...
- `2026-09-15` PR `#107`, API/Web SHA `c0e09c4`로 API 선배포 후 웹을 배포했다. ArgoCD `Synced Healthy`, 운영 새/기존 로그 계약 200과 실행 번들 반영을 확인했으며, 사용자가 운영 앱에서 50개 이후 기록의 정상 노출을 직접 확인했다.
